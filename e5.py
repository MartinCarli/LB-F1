#  LA PRIMA PARTE E` UGUALE AL ES 4



#prima c`era un errore nel confronto, avevo dei problemi con il self e l a ----non serve mettere due variabili nell graffe----
